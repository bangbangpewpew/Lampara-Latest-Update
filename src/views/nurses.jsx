    ...
    <div className="nurses-container">
      ...
      <div className="nurses-container2">
        <div className="nurses-container3">
          ...
          <Link to="/" className="nurses-navlink7 button">
            Log Out
          </Link>
          <svg viewBox="0 0 1024 1024" className="nurses-icon24">
          ...
          <div className="nurses-container4">
            ...
            <span className="nurses-text05" onClick={handleFilterClick}>Filter</span> 
