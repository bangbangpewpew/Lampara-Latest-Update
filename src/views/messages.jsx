      ...
      {isFileUploadVisible && (
        ...
        <div className="messages-container02">
          <div className="messages-container03">
            ...
            <Link to="/" className="messages-navlink8 button">
            Log Out
          </Link>
          <svg viewBox="0 0 1024 1024" className="messages-icon25">
      ...
      <div className="messages-container04">
        ...
        <div className="messages-container05">
          ...
          <div className="messages-container09">
            ...
            <svg viewBox="0 0 1024 1024" className="messages-icon24" onClick={toggleFileUpload}>
